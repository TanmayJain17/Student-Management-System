...
app.config['SQLALCHEMY_DATABASE_URI']='mysql://studentuser:studentpass@127.0.0.1/studentdbms'

###app.config['MYSQL_HOST'] = '127.0.0.1'
###app.config['MYSQL_USER'] = 'root'
###app.config['MYSQL_PASSWORD'] = 'tanmax@2000'
###app.config['MYSQL_DB'] = 'studentdbms'
